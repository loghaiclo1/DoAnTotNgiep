<div class="form-group">
    ...
    <input type="text" name="TenSach" id="TenSach" class="form-control @error('TenSach') is-invalid @enderror"
        value="{{ old('TenSach') }}" required>
    @error('TenSach')
...
<div class="form-group">
    ...
    <input type="file" name="HinhAnh" id="HinhAnh"
        class="form-control-file @error('HinhAnh') is-invalid @enderror" accept=".jpg,.jpeg,.png,.webp" required>
    @error('HinhAnh')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
