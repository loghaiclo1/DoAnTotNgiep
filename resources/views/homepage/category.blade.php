                     ...
                     <div class="widgets-container">
                                 ...
                                 @foreach ($categories as $cat)
                                     <li class="category-item">
                                         <div class="d-flex justify-content-between align-items-center category-header {{ $cat->children->count() ? 'collapsed' : '' }}"
                                             @if ($cat->children->count()) data-bs-toggle="collapse"
                                                data-bs-target="#cat-sub-{{ $cat->id }}"
                                                aria-expanded="false"
                                                aria-controls="cat-sub-{{ $cat->id }}" @endif>
                         ...
                         <form method="GET" action="{{ route('category.index') }}">
                             ...
                             <div class="pricing-range-widget widget-item">
                                 ...
                                 <div class="price-range-container">
                                     ...
                                     <div class="current-range mb-3">
                                         ...
                                         <span class="max-price float-end">{{ number_format($maxPrice, 0, ',', '.') }}
                                             VND</span>
                                     </div>
                                     ...
                                     <div class="range-slider">
                                         ...
                                         <input type="range" class="min-range" min="{{ $minPrice }}"
                                             max="{{ $maxPrice }}" name="price_min" value="{{ $minPrice }}"
                                             step="1000">
                                         <input type="range" class="max-range" min="{{ $minPrice }}"
                                             max="{{ $maxPrice }}" name="price_max" value="{{ $maxPrice }}"
                                             step="1000">
                                     </div>
                                             ...
                                             <div class="col-6">
                                                 <div class="input-group input-group-sm">
                                                     ...
                                                     <input type="number" name="price_min"
                                                         class="form-control min-price-input" placeholder="Min"
                                             ...
                                             <div class="col-6">
                                                 <div class="input-group input-group-sm">
                                                     ...
                                                     <input type="number" name="price_max"
                                                         class="form-control max-price-input" placeholder="Max"
                                                         min="{{ $minPrice }}" max="{{ $maxPrice }}"
                             ...
                             <div class="filter-item mb-4">
                                 ...
                                 <div class="form-check-group d-flex flex-wrap text-start"
                             ...
                             <div class="filter-item">
                                 ...
                                 <div class="form-check-group d-flex flex-wrap gap-2"
                                     ...
                                     <div class="form-check form-check-inline" style="width: 40%">
                                         <input class="form-check-input" type="radio" name="per_page" value="12"
                                             {{ $currentPerPage == '12' ? 'checked' : '' }}>
                                         <span class="form-check-label">12 sách / trang</span>
                                     </div>

                                     <div class="form-check form-check-inline" style="width: 40%">
                                         <input class="form-check-input" type="radio" name="per_page" value="24"
                                             {{ $currentPerPage == '24' ? 'checked' : '' }}>
                                         <span class="form-check-label">24 sách / trang</span>
                                     </div>

                                     <div class="form-check form-check-inline" style="width: 40%">
                                         <input class="form-check-input" type="radio" name="per_page" value="48"
                                             {{ $currentPerPage == '48' ? 'checked' : '' }}>
                                         <span class="form-check-label">48 sách / trang</span>
                                     </div>

                                     <div class="form-check form-check-inline" style="width: 40%">
                                         <input class="form-check-input" type="radio" name="per_page" value="96"
                                             {{ $currentPerPage == '96' ? 'checked' : '' }}>
                                         <span class="form-check-label">96 sách / trang</span>
                                     </div>
                                 </div>
                             </div>
                                         ...
                                         <div class="active-filters">
                                             ...
                                             <div class="filter-tags">
                                                 ...
                                                 @if (request('price_min') && request('price_max'))
                                                     <span class="filter-tag">
                                                         Giá: {{ number_format(request('price_min'), 0, ',', '.') }}đ -
                                                         {{ number_format(request('price_max'), 0, ',', '.') }}đ
                                                 ...
                                                 @if (request()->query())
                                                     <a href="{{ route('category.index') }}"
                                                         class="btn btn-sm btn-outline-secondary clear-all-btn ms-2">
                                                         Xóa tất cả
                                                     </a>
                                                 @endif
                                             </div>
                                     ...
                                     <div class="col-md-6 col-lg-4">
                                         <div class="product-box" style="height: 435px">
                                             <div class="product-thumb" style="position: relative; height: 261.33px;">
                                                 <img src="{{ asset('image/book/' . $book->HinhAnh) }}"
                                                     alt="{{ $book->TenSach }}"
                                                 ...
                                                 <div class="product-overlay" data-book-id="{{ $book->MaSach }}">
                                                     ...
                                                     <div class="cart-form-area">
                                                         @if ($book->SoLuong <= 0)
                                                             <button class="btn btn-secondary btn-add-to-cart btn-disabled"
                                                                 disabled>
                                             ...
                                             <div class="product-content">
                                                 <div class="product-details">
                                                     <h3 class="product-title" style="min-height: 20px"><a
                                                             href="{{ route('product.detail', $book->slug) }}">{{ $book->TenSach }}</a>
                                                     </h3>
                                                 ...
                                                 <div style="color: #7A7E7F; margin-bottom: 5px;">Đã bán
                                                     {{ $book->LuotMua }} </div>
